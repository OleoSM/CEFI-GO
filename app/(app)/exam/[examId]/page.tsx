...
const TOTAL_SECONDS = 2 * 60 * 60 + 30 * 60; // 2h 30min
      ...
      <div className="max-w-xl mx-auto text-center py-16 space-y-6">
        ...
        <div className="card">
          ...
          <p className="text-white/60">
            {correct} correctas de {totalQ} preguntas
          </p>
        </div>
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <header className="flex items-center justify-between gap-4 mb-6">
        ...
        {/* Timer */}
        <div
          className={`flex items-center gap-2 px-4 py-2 rounded-xl font-mono font-bold text-lg border ${
            timeLeft < 600
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <aside className="space-y-4">
          <div className="card">
            <h2
              className="font-black mb-4 text-sm"
          ...
          <div className="card text-sm">
            <div className="flex justify-between py-1.5 border-b border-white/5">
              ...
              <span className="font-bold">{totalQ}</span>
            </div>
            <div className="flex justify-between py-1.5 border-b border-white/5">
            ...
            <div className="flex justify-between py-1.5 border-b border-white/5">
              <span className="text-white/50">Marcadas</span>
              <span className="font-bold text-amber-400">{marked.size}</span>
            </div>
            <div className="flex justify-between py-1.5">
              <span className="text-white/50">Sin responder</span>
              <span className="font-bold text-white/40">{totalQ - answered}</span>
            </div>
          </div>
        </aside>
      </div>
